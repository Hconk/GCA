...
#if defined(NDEBUG)
# error "GCA cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "GCA Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s GCA additional fees, %d delta bytes\n",
...
bool CVerifyDB::VerifyDB(const CChainParams& chainparams, CCoinsView *coinsview, int nCheckLevel, int nCheckDepth)
{
    ...
    if (nCheckDepth <= 0)
        // GCA: suffices until year 10214. Didn't x4 value due to integer wrap around and upstream compatibility.
