...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gca-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gca-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gca transaction") + "\n" +
              "  gca-tx [options] -create [commands]   " + _("Create hex-encoded gca transaction") + "\n" +
              "\n";
