...
const char * const BITCOIN_CONF_FILENAME = "gca.conf";
const char * const BITCOIN_PID_FILENAME = "gca.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GCA";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/GCA";
#else
    // Unix
    return pathRet / ".gca";
#endif
